        ...
        bgcolor="#3b65ad",
            ...
            ft.Column(
                    controls=(
                        ft.ResponsiveRow(
                                [
                                    ft.TextButton(text='Dicas de pesquisa', style=ft.ButtonStyle(color="#3b65ad"), on_click=go_dicas)
                                ]
                        ),
                        ft.ResponsiveRow(
                                [
                                    ft.TextButton(text='Perguntas frequentes', style=ft.ButtonStyle(color="#3b65ad"), on_click=go_perguntas)
                                ],
                        ),
                        ft.ResponsiveRow(
                                [
                                    ft.TextButton(text='Sobre', style=ft.ButtonStyle(color="#3b65ad"), on_click=go_sobre)
                                ],
                        ),
                    ),
                )
            ...
            page.views.append(
                ft.View(
                    ...
                    [
                        ft.AppBar(
                            title=ft.Text(
                                "Perguntas frequentes", weight=ft.FontWeight.BOLD, color="white"
                            ),
                            bgcolor="#3b65ad",
                            center_title=True,
                            actions=[ft.IconButton(ft.icons.MENU, tooltip="Menu", icon_color="black")]
